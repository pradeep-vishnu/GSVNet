...
class cityscape_dataset(Dataset):
    def __init__(self, config, mode = 'train', interval = 0, label_transform = standard_transforms.ToTensor(), img_transform = standard_transforms.ToTensor(), bi_direction = False):
        ...
        if mode == 'train' :
            file_path = "~/repos/GSVNet/dataset/cityscapes/train.txt"
        elif mode == 'val':
            file_path = "~/repos/GSVNet/dataset/cityscapes/val.txt"
        elif mode == 'test':
            file_path = "~/repos/GSVNet/dataset/cityscapes/test.txt"
